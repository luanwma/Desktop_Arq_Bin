...
public class PesquisaUsuario extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setBounds(30, 40, 230, 30);

        jTextField1.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        getContentPane().add(jTextField1);
        jTextField1.setBounds(280, 40, 150, 40);
        ...
        btnListar.setBounds(110, 110, 160, 40);
        ...
        btnExcluir.setBounds(830, 140, 40, 40);
        ...
        tabUsers.setColumnSelectionAllowed(true);
        jScrollPane1.setViewportView(tabUsers);
        tabUsers.getColumnModel().getSelectionModel().setSelectionMode(javax.swing.ListSelectionModel.SINGLE_SELECTION);

        getContentPane().add(jScrollPane1);
        jScrollPane1.setBounds(350, 120, 452, 402);
    ...
    private void btnListarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnListarActionPerformed
        try {
            try {
                dadostabela(controle.listaUsuarios());
    ...
    private void btnExcluirActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnExcluirActionPerformed
        String nome = selecionarNome(), senha = selecionarSenha();
        int op = JOptionPane.showConfirmDialog(null, "Tem certeza que deseja remover o Usuário?","Excluir Usuário",JOptionPane.YES_NO_OPTION);
        if(op == JOptionPane.YES_OPTION){
            try {
                controle.excluirUsuario(nome, senha);
                if(controle.novoArquivo() == true){
...
public void dadostabela(ArrayList listUsers){
    String [] colunas = new String[]{"NOME ","SENHA"};          
         
            ModeloTabela modelo = new ModeloTabela(listUsers, colunas);
            
            tabUsers.setModel(modelo);
            tabUsers.getColumnModel().getColumn(0).setPreferredWidth(80);
            tabUsers.getColumnModel().getColumn(0).setResizable(true);
            tabUsers.getColumnModel().getColumn(1).setPreferredWidth(100);
            tabUsers.getColumnModel().getColumn(1).setResizable(true);
           /* tabUsers.getColumnModel().getColumn(2).setPreferredWidth(80);
            tabUsers.getColumnModel().getColumn(2).setResizable(true); */
    ...
    public String selecionarNome(){
        int linha = tabUsers.getSelectedRow();
        System.out.println("linha "+linha);
        String nome = (String) tabUsers.getValueAt(linha,0);
        return nome;
    }
    public String selecionarSenha(){
        int linha = tabUsers.getSelectedRow();
        String senha = (String) tabUsers.getValueAt(linha,1);
        return senha;
    }
