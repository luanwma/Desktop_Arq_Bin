...
public class PesquisaVenda extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        tabVendas.setFont(new java.awt.Font("Tahoma", 0, 12)); // NOI18N
        tabVendas.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Id do Cliente", "Tipo de Cliente", "Nome do Cliente", "Documento 1", "Documento 2", "Telefone", "Email"
            }
        ) {
        ...
        tabVendas.setColumnSelectionAllowed(true);
        tabVendas.setRowHeight(20);
        tabVendas.setSelectionMode(javax.swing.ListSelectionModel.SINGLE_SELECTION);
        jScrollPane1.setViewportView(tabVendas);
        tabVendas.getColumnModel().getSelectionModel().setSelectionMode(javax.swing.ListSelectionModel.SINGLE_SELECTION);
    ...
    private void btnBuscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBuscarActionPerformed
       ...
       // ControleCliente controlecliente  = new ControleCliente();
        ...
        try {
            // controlVenda.atualizaTabela(tabVendas, colunas);
            tabVendas = controlCli.dadostabela(tabVendas,  controlCli.buscaCliente(nomebusca) , colunas);
    ...
    private void btnDetalhesActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDetalhesActionPerformed
        ...
        int id = controlVenda.selecionarId( tabVendas);
        String [] colunas = new String[]{"Id da Venda", "ID do Produto","Nome do Produto","Descrição",
            "Quantidade","Preço por Item","Preço Total"};
        try {
            controlVenda.listagemVendas(id);
            tableDetalhes = controlVenda.dadostabela(tableDetalhes, controlVenda.impressaoTabela(), colunas);
        } catch (IOException ex) {
            Logger.getLogger(PesquisaVenda.class.getName()).log(Level.SEVERE, null, ex);
        }
