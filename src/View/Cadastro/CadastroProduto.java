...
public class CadastroProduto extends javax.swing.JFrame {
    ...
    public CadastroProduto(boolean config, int id){
        initComponents();
        this.id = id;
        config = config;
        confBotoes(config);
    ...
    private void btnEditarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEditarActionPerformed
        ...
        try{
            ...
            controle.deleteProdutofromLista(id);
            controle.deleteFile();
            if(controle.gravarProdutoOrdenadoNalista(id, controle.criarProduto(true, id, nome, pnum, descricao))){
                
            }
            if(controle.novoarquivo()){
    ...
    private void btnSalvarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSalvarActionPerformed
        ...
        try{
            ...
            if(controle.gravarProdutoArquivo(controle.criarProduto(false, id, nome, pnum, descricao), true) == true){
