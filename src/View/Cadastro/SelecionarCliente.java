...
public class SelecionarCliente extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        btnListarProd.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        ...
        btnListarProd.setBounds(20, 30, 100, 30);
        ...
        tabClientes.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "Tipo", "Nome", "RG / Nome Fantasia", "CPF / CNPJ", "Telefone", "Email"
            }
        ) {
        ...
        if (tabClientes.getColumnModel().getColumnCount() > 0) {
            ...
            tabClientes.getColumnModel().getColumn(1).setPreferredWidth(40);
            tabClientes.getColumnModel().getColumn(2).setPreferredWidth(60);
            tabClientes.getColumnModel().getColumn(3).setPreferredWidth(70);
            tabClientes.getColumnModel().getColumn(4).setPreferredWidth(70);
            tabClientes.getColumnModel().getColumn(5).setPreferredWidth(50);
            tabClientes.getColumnModel().getColumn(6).setPreferredWidth(120);
        }

        getContentPane().add(jScrollPane1);
        jScrollPane1.setBounds(100, 100, 810, 440);

        txtBuscaNome.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        txtBuscaNome.setPreferredSize(new java.awt.Dimension(16, 23));
        getContentPane().add(txtBuscaNome);
        txtBuscaNome.setBounds(380, 30, 150, 30);
        ...
        btnBuscar.setBounds(550, 30, 120, 30);

        jLabel1.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        jLabel1.setText("Digite o nome do Cliente");
        getContentPane().add(jLabel1);
        jLabel1.setBounds(150, 30, 210, 30);
    ...
    private void btnListarProdActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnListarProdActionPerformed
        ...
        String [] colunas = new String[]{"ID ","TIPO","NOME","RG / NOME FANTASIA","CPF / CNPJ","TELEFONE","EMAIL"};
        
        try {
            tabClientes = control.dadostabela(tabClientes,control.printLista(), colunas);
            /*
            String [] colunas = new String[]{"ID ","TIPO","NOME","RG / NOME FANTASIA","CPF / CNPJ","TELEFONE","EMAIL"};
            try{
            tabClientes = control.dadostabela(tabClientes, control.listaClientes(), colunas);
            id = control.selecionarId(tabClientes);
    ...
    private void btnBuscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBuscarActionPerformed
        controlVenda = new ControleVenda();
        String [] colunas = new String[]{"ID ","TIPO","NOME","RG / NOME FANTASIA","CPF / CNPJ","TELEFONE","EMAIL"};
        String id = (  txtBuscaNome.getText());
        try {
            tabClientes = control.dadostabela(tabClientes, control.buscaCliente(id), colunas);
        } catch (IOException ex) {
            Logger.getLogger(SelecionarCliente.class.getName()).log(Level.SEVERE, null, ex);
        }
